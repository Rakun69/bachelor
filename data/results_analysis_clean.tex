...
Diese experimentelle Evaluation vergleicht Standard ZK-SNARKs mit Recursive Nova-SNARKs für IoT Smart Home Anwendungen. Die Ergebnisse zeigen einen klaren Crossover Point bei ca. 20 IoT-Elementen, ab dem Recursive SNARKs exponentiell überlegen werden.

\subsection{Haupterkenntnisse}

\begin{itemize}
    \item \textbf{Crossover Point:} 20-25 IoT-Sensordaten
    \item \textbf{Maximum Speedup:} $16.6 \times$ bei 500 Elementen  
    \item \textbf{Verifikations-Reduktion:} 500:1 (eine statt 500 Verifikationen)
    \item \textbf{Datenbasis:} 107,712 realistische IoT-Sensordaten aus Smart Home Simulation
\end{itemize}
...
\begin{itemize}
    ...
    \item \textbf{1-Tages Batches:} Crossover Point für Standard$\rightarrow$Nova bei 1,440 Readings
